...
() {
  ...
  # Core colors
  typeset -g P10K_COLOR_BASE="#080808"   # Deep Gothic Black
  typeset -g P10K_COLOR_MANTLE="#121212" # Dark Charcoal
  typeset -g P10K_COLOR_CRUST="#020202"  # Near Pitch Black
  
  # Text and Subtext
  typeset -g P10K_COLOR_TEXT="#f5f5dc"     # Cream / Off-white
  typeset -g P10K_COLOR_SUBTEXT1="#cdaf7d" # Muted Gold
  typeset -g P10K_COLOR_SUBTEXT0="#8a7355" # Muted Bronze
  
  # Overlays
  typeset -g P10K_COLOR_OVERLAY2="#8a7355" # Muted Bronze
  typeset -g P10K_COLOR_OVERLAY1="#5c4a36" # Dark Bronze
  typeset -g P10K_COLOR_OVERLAY0="#3b2f22" # Very Dark Bronze
  
  # Surfaces
  typeset -g P10K_COLOR_SURFACE2="#2d2d2d" # Dark Charcoal
  typeset -g P10K_COLOR_SURFACE1="#1c1c1c" # Deep Charcoal
  typeset -g P10K_COLOR_SURFACE0="#121212" # Charcoal
  
  # Accent colors
  typeset -g P10K_COLOR_BLUE="#b87333"      # Copper
  typeset -g P10K_COLOR_LAVENDER="#cd7f32"  # Bronze
  typeset -g P10K_COLOR_SAPPHIRE="#966a38"  # Antique Gold (Dark)
  typeset -g P10K_COLOR_SKY="#d4af37"       # Antique Gold
  typeset -g P10K_COLOR_TEAL="#c5a059"      # Muted Gold
  typeset -g P10K_COLOR_GREEN="#bfa260"     # Golden Amber
  typeset -g P10K_COLOR_YELLOW="#ffbf00"    # Amber
  typeset -g P10K_COLOR_PEACH="#d4af37"     # Gold
  typeset -g P10K_COLOR_RED="#800020"       # Deep Blood-Red
  typeset -g P10K_COLOR_MAROON="#58111a"    # Burgundy / Blood-Red
  typeset -g P10K_COLOR_PINK="#e6c280"      # Light Gold
  typeset -g P10K_COLOR_FLAMINGO="#f0d5a6"  # Pale Cream Gold
  typeset -g P10K_COLOR_ROSEWATER="#faf9f6" # Cream Off-white
  typeset -g P10K_COLOR_MAUVE="#d4af37"     # Gold
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$P10K_COLOR_MAUVE
...
# Fix prompt connectors on terminal resize
TRAPWINCH() {
